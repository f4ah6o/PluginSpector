...
IMAGE="${PLUGINSPECTOR_DOCKER_IMAGE:-pluginspector}"
REPO_DIR="${PLUGINSPECTOR_REPO_DIR:-$(pwd)}"
LOCAL_REPORT="${PLUGINSPECTOR_DOCKER_LOCAL_REPORT:-.pluginspector-docker-smoke.json}"
GITHUB_REPORT="${PLUGINSPECTOR_DOCKER_GITHUB_REPORT:-.pluginspector-docker-github-smoke.json}"
GITHUB_URL="${PLUGINSPECTOR_DOCKER_GITHUB_URL:-https://github.com/octocat/Hello-World}"
GITHUB_EXPECTED_COMPONENT="${PLUGINSPECTOR_DOCKER_GITHUB_EXPECTED_COMPONENT:-README}"
