...
from pluginspector.llm_utils import get_chat_model
from pluginspector.logging_config import get_logger
from pluginspector.model_info import get_max_input_tokens
...
class LLMFinding(BaseModel):
    ...
    Field names intentionally mirror :class:`~pluginspector.models.Finding` so
