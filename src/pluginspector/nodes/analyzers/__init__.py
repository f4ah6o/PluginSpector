...
from pluginspector.nodes.analyzers.behavioral_ast import node as behavioral_ast_node
from pluginspector.nodes.analyzers.behavioral_taint_tracking import (
    node as behavioral_taint_tracking_node,
)
from pluginspector.nodes.analyzers.claude_capability_correlation import (
    node as claude_capability_correlation_node,
)
from pluginspector.nodes.analyzers.claude_components import node as claude_components_node
from pluginspector.nodes.analyzers.claude_hooks import node as claude_hooks_node
from pluginspector.nodes.analyzers.claude_mcp_lsp import node as claude_mcp_lsp_node
from pluginspector.nodes.analyzers.claude_plugin_structure import (
    node as claude_plugin_structure_node,
)
from pluginspector.nodes.analyzers.mcp_least_privilege import node as mcp_least_privilege_node
from pluginspector.nodes.analyzers.mcp_rug_pull import node as mcp_rug_pull_node
from pluginspector.nodes.analyzers.mcp_tool_poisoning import node as mcp_tool_poisoning_node
...
from pluginspector.nodes.analyzers.static_patterns_data_exfiltration import (
    node as static_patterns_data_exfiltration_node,
)
from pluginspector.nodes.analyzers.static_patterns_excessive_agency import (
    node as static_patterns_excessive_agency_node,
)
from pluginspector.nodes.analyzers.static_patterns_harmful_content import (
    node as static_patterns_harmful_content_node,
)
from pluginspector.nodes.analyzers.static_patterns_memory_poisoning import (
    node as static_patterns_memory_poisoning_node,
)
from pluginspector.nodes.analyzers.static_patterns_output_handling import (
    node as static_patterns_output_handling_node,
)
from pluginspector.nodes.analyzers.static_patterns_privilege_escalation import (
    node as static_patterns_privilege_escalation_node,
)
from pluginspector.nodes.analyzers.static_patterns_prompt_injection import (
    node as static_patterns_prompt_injection_node,
)
from pluginspector.nodes.analyzers.static_patterns_rogue_agent import (
    node as static_patterns_rogue_agent_node,
)
from pluginspector.nodes.analyzers.static_patterns_supply_chain import (
    node as static_patterns_supply_chain_node,
)
from pluginspector.nodes.analyzers.static_patterns_system_prompt_leakage import (
    node as static_patterns_system_prompt_leakage_node,
)
from pluginspector.nodes.analyzers.static_patterns_tool_misuse import (
    node as static_patterns_tool_misuse_node,
)
from pluginspector.nodes.analyzers.static_yara import node as static_yara_node
